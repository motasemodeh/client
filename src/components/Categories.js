...
const Categories = () => {
  return (
    <div className='max-w-[1520px] m-auto py-12'>
        <h1 className='text-orange-500 font-bold text-2xl text-center'>Trending Categories</h1>
        <div className='grid grod-cpls-2 md:grid-cols-6 gap-5 px-2'>
            {
                categories.map((item) => {
